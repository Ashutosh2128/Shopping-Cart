            ...
            <div className="flex flex-col">
              ...
              <div className="flex gap-4 mt-5">
                <button
                  ...
                  className="bg-red-500 hover:bg-red-600 text-white font-bold p-3 rounded-lg transition"
                >
                  Clear Cart
                </button>

                <button
                  className="bg-green-700 hover:bg-green-800 text-white font-bold p-3 rounded-lg transition flex-1"
                >
                  CheckOut Now
                </button>
              </div>
